...
\title{Отзыв научного руководителя \practiceType\ практике обучающегося \studentName\ на тему \enquote{\practiceTitle} за \practiceSemester\ семестр}
...
\ifdefstring{\contributionType}{pullrequest}{
    ...
    \ifdefstring{\contributionType}{newRepo}{
        ...
        \begin{itemize}
            ...
            \item[\checkmarkEntry{\tests}] настроен CI с модульными тестами и линтером
